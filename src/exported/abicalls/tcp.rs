...
#[no_mangle]
pub fn sys_tcp_set_no_delay(_handle: Handle, _mode: bool) -> Result<(), ()> {
	Err(())
}
...
#[cfg(feature = "tcp")]
#[no_mangle]
pub fn sys_tcp_stream_peer_addr(_handle: Handle) -> Result<(IpAddress, u16), ()> {
	Err(())
}

#[cfg(feature = "tcp")]
#[no_mangle]
pub fn sys_tcp_listener_accept(_port: u16) -> Result<(Handle, IpAddress, u16), ()> {
	Err(())
}
