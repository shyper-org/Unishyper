...
impl InterruptControllerTrait for InterruptController {
    ...
    fn enable(i: Interrupt) {
        ...
        match core_id {
            0 => plic.InterruptEnableCtx1[reg_idx]
                .set(plic.InterruptEnableCtx1[reg_idx].get() | bit_mask),
            1 => plic.InterruptEnableCtx3[reg_idx]
                .set(plic.InterruptEnableCtx3[reg_idx].get() | bit_mask),
            2 => plic.InterruptEnableCtx5[reg_idx]
                .set(plic.InterruptEnableCtx5[reg_idx].get() | bit_mask),
            3 => plic.InterruptEnableCtx7[reg_idx]
                .set(plic.InterruptEnableCtx7[reg_idx].get() | bit_mask),
            _ => panic!(),
        }
